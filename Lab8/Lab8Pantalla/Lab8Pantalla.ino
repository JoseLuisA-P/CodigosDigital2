...
void setup() {
  ...
  FillRect(50, 30, 240, 180, 0xf4f4);
  
  //textos de la SD
  String encontrada = "SD encontrada";
  String nencontrada = "SD no encontrada";
  if(!SD.begin(chipSelect)){ //inicia la SD y determina si se logra o no
    LCD_Print(nencontrada,100,110,1,0xffff,0x0000);
    return;
    }
  LCD_Print(encontrada,55,35,1,0x0000,0xf4f4);
